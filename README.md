...
سایت دانلود: [`website/`](website/) — دکمه‌های ویندوز و لینوکس همیشه آخرین release گیت‌هاب را می‌گیرند. پس از publish با workflow `Deploy website`: [mortenaho.github.io/morixterm](https://mortenaho.github.io/morixterm/)
